        ...
        <div class="main-wrap">
            ...
            <div class="result-wrap">
                <div class="result-content">
                    <form action="/mywebblog/index.php/Admin/Admin/insert" method="post" id="myform" name="myform">
                        <table class="insert-tab" width="100%">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="common-text required" id="title" name="username" size="50" value="" type="text" placeholder="请输入用户名称">
                                    </td>
                                </tr>
                                <tr>
