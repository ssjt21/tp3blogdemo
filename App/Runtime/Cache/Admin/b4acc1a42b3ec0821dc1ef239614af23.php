...
<body>
    <!--/mywebblog/index.php/Admin/Cate /mywebblog/index.php/Admin /mywebblog/index.php /mywebblog /mywebblog/Public-->
    ...
    <div class="sidebar-content">
        ...
        <div class="main-wrap">
            ...
            <div class="crumb-wrap">
                <div class="crumb-list"><i class="icon-font"></i><a href="/mywebblog/index.php/Admin/Index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">栏目管理</span></div>
            </div>
            <div class="search-wrap">
                <div class="search-content">
                    <form action="/mywebblog/index.php/Admin/Cate/index" method="post">
            ...
            <div class="result-wrap">
                <form action="/mywebblog/index.php/Admin/Cate/sort" name="myform" id="myform" method="post">
                    <div class="result-title">
                        <div class="result-list">
                            <a href="/mywebblog/index.php/Admin/Cate/add"><i class="icon-font"></i>新增栏目</a>
                            <a id="batchDel" href="javascript:void(0)"><i class="icon-font"></i>批量删除</a>
                            <!--<a id="updateOrd" href="/mywebblog/index.php/Admin/Cate/sort"><i class="icon-font"></i>更新排序</a>-->
                    ...
                    <div class="result-content">
                        <table class="result-tab" width="100%">
                            ...
                            <?php if(is_array($catelist)): foreach($catelist as $key=>$vo): ?><tr>
                                    <td class="tc"><input name="id[]" value="59" type="checkbox"></td>
                                    <td>
                                        <input name="id" value="<?php echo ($vo["id"]); ?>" type="hidden">
                                        <input class="common-input sort-input" name="<?php echo ($vo["id"]); ?>" value="<?php echo ($vo["sortid"]); ?>" type="text">
                                    </td>
                                    <td><?php echo ($vo["id"]); ?> </td>
                                    <td title="">
                                        <a target="_blank" href="#" title=""></a><?php echo ($vo["catename"]); ?>
                                    </td>

                                    <td>
                                        <a class="" href="/mywebblog/index.php/Admin/Cate/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                        <a class="link-del" href="/mywebblog/index.php/Admin/Cate/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                                    </td>
