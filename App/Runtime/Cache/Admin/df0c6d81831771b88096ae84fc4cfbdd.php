    ...
    <div class="sidebar-content">
        ...
        <div class="main-wrap">
            ...
            <div class="crumb-wrap">
                <div class="crumb-list"><i class="icon-font"></i><a href="/mywebblog/index.php/Admin/Index/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/mywebblog/index.php/Admin/Admin/index">用户管理</a><span class="crumb-step">&gt;</span><span>新增用户</span></div>
            </div>
            <div class="result-wrap">
                <div class="result-content">
                    <form action="/mywebblog/index.php/Admin/Admin/update" method="post" id="myform" name="myform">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input class="common-text required" id="title" name="catename" size="50" type="text" placeholder="请输入用户名称" value="<?php echo ($admin["username"]); ?>">
                                    </td>
                                </tr>
                                <tr>
                                    <th><i class="require-red">*</i>用户密码：</th>
                                    <td>
                                        <input class="common-text required" id="title" name="password" size="50" value="" type="password" placeholder="请输入用户密码">
                                    </td>
                                </tr>
                                <tr>
                                    <th><i class="require-red">*</i>确认密码：</th>
                                    <td>
                                        <input class="common-text required" id="title" name="repassword" size="50" value="" type="password" placeholder="请输入确认密码">
                                    </td>
                                </tr>
