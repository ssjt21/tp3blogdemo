    ...
    <div class="sidebar-content">
        ...
        <div class="main-wrap">
            ...
            <div class="crumb-wrap">
                <div class="crumb-list"><i class="icon-font"></i><a href="/mywebblog/index.php/Admin/Index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">作品管理</span></div>
            </div>
            <div class="search-wrap">
                <div class="search-content">
                    <form action="/mywebblog/index.php/Admin/Article/index" method="post">
                ...
                <form name="myform" id="myform" method="post">
                    <div class="result-title">
                        <div class="result-list">
                            <a href="/mywebblog/index.php/Admin/Article/add"><i class="icon-font"></i>新增作品</a>
                        ...
                        <table class="result-tab" width="100%">
                            ...
                            <?php if(is_array($articlelist)): foreach($articlelist as $key=>$vo): ?><tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if($vo["pic"] != ''): ?><img src="/mywebblog/Public/<?php echo ($vo["pic"]); ?>" height="50" width="80">
                                            <?php else: ?> 无缩略图<?php endif; ?>
                                    </td>
                                    <td title="">
                                        <a target="_blank" href="#" title=""></a><?php echo ($vo["title"]); ?>
                                    </td>
                                    <td><?php echo ($vo["adesc"]); ?></td>
                                    ...
                                    <td>
                                        <a class="link-update" href="/mywebblog/index.php/Admin/Article/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                        <a class="link-del" href="/mywebblog/index.php/Admin/Article/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                                    </td>
