...
<body>
    <!--/mywebblog/index.php/Admin/Index /mywebblog/index.php/Admin /mywebblog/index.php /mywebblog /mywebblog/Public-->
    ...
    <div class="sidebar-content">
        ...
        <div class="main-wrap">
            <div class="crumb-wrap">
                <div class="crumb-list"><i class="icon-font">&#xe06b;</i><span style="color: red">MYWEB</span></div>
            </div>
            <div class="result-wrap">
                ...
                <div class="result-content">
                    <div class="short-wrap">
                        ...
                        <a href="/mywebblog/index.php/Admin/Cate/add"><i class="icon-font">&#xe048;</i>新增作品分类</a>
                        <a href="/mywebblog/index.php/Admin/FLink/add"><i class="icon-font">&#xe041;</i>新增友情链接</a>
                        <a href="/mywebblog/index.php/Admin/Admin/add"><i class="icon-font">&#xe01e;</i>新增管理员</a>
                    </div>
                </div>
            </div>
            <div class="result-wrap">
            ...
            <div class="result-wrap">
                ...
                <div class="result-content">
                    <ul class="sys-info-list">
                        <li>
                            <label class="res-lab">王帝QQ：</label><span class="res-info">1260945877</span>
                        </li>
